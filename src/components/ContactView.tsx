            ...
            {!formSubmitted ? (
              ...
              >
                ...
                <div className="bg-[#EFECE6] border border-zinc-200 p-6 rounded-none text-left max-w-md mx-auto space-y-4 font-mono text-[10px] tracking-wider text-zinc-650 leading-relaxed uppercase">
                  ...
                  <p>● ESTIMATED REVIEW CYCLE: 24 HOURS</p>
                  <p>● INTERFACE STATE: {(!serviceId || !templateId || !publicKey) ? 'DEMO SIMULATOR (SET LIAISON KEYS TO GO LIVE)' : 'SECURE ACTIVE EMAILJS INTERFACE'}</p>
                </div>
